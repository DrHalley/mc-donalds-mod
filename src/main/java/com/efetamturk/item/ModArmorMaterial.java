...
public enum ModArmorMaterial implements ArmorMaterial {
    ...
    MCDONALDS("mcdonalds", 25, new int[] { 3, 8, 6, 3 }, 19,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 2f, 0.1f, () -> Ingredient.ofItems(Items.RED_WOOL));
    ...
    public String getName() {
        return McDonaldsMod.MOD_ID + ":" + this.name;
    }
